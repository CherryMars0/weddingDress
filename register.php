        ...
        <div class="main">
            <div class="main_left">
                <div class="loginContainer">
                    <p class="loginTitle fadeInLeft animated">register</p>
                    <div class="login fadeInLeft animated">
                        <form class="loginForm" id="loginForm" method="post">
                            ...
                            <div class="inputBox">
                                ...
                                <input id="replacePassword" type="password" name="replaceUserPassword" placeholder="replace password" />
                            </div>
                            <div class="inputBox">
                                <p>
                        ...
                        <button class="loginBtn fadeInLeft animated" id="login">注册</button>
